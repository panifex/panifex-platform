...
public class LoginFormRichlet extends AbstractRichlet {
	...
	protected Component createContent() {
		...
		getBinder().addPropertyLoadBindings(usernameTextbox, "value", "vm.username", null, null, null, null, null);
		getBinder().addPropertySaveBindings(usernameTextbox, "value", "vm.username", null, null, null, null, null, null, null);
		...
		getBinder().addPropertyLoadBindings(passwordTextbox, "value", "vm.password", null, null, null, null, null);
		getBinder().addPropertySaveBindings(passwordTextbox, "value", "vm.password", null, null, null, null, null, null, null);
		...
		final Checkbox remembermeCheckbox = new Checkbox(getLabel("login.form.field.rememberme.label"));
		...
		getBinder().addPropertyLoadBindings(remembermeCheckbox, "checked", "vm.isRememberMe", null, null, null, null, null);
		getBinder().addPropertySaveBindings(remembermeCheckbox, "checked", "vm.isRememberMe", null, null, null, null, null, null, null);
