...
/**
 * Unit tests for {@link HTMLInputToPasswordInputAdapter} class.
 */
public class HTMLInputToPasswordInputAdapterTest extends TestSupport {

    // mocks
    private final HTMLInputElement inputElementMock = createMock(HTMLInputElement.class);

    private final HTMLInputToPasswordInputAdapter adapter = new HTMLInputToPasswordInputAdapter(inputElementMock);
