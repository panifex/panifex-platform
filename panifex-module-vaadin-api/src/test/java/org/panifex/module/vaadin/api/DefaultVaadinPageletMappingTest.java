...
/**
 * Unit tests for {@link DefaultVaadinPageletMapping} class.
 */
public class DefaultVaadinPageletMappingTest extends TestSupport {
    ...
    public void testConstructWithPageletName() {
        PageletMapping mapping = new DefaultVaadinPageletMapping(pageletName, urlPatterns);
    ...
    public void testConstructWithConcretePagelet() {
        VaadinPagelet pageletMock = createMock(VaadinPagelet.class);
        expect(pageletMock.getName()).andReturn(pageletName);

        replayAll();
        PageletMapping mapping = new DefaultVaadinPageletMapping(pageletMock, urlPatterns);
        verifyAll();
